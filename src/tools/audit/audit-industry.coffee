...
exports = module.exports = class AuditIndustry
  ...
  @audit: (root_dir) -> new Promise (resolve, reject) ->
    try
      ...
      city_zones = FileUtils.parse_files(root_dir, ['city-zones.json'], [], STARPEACE.industry.CityZone.fromJson)
      ...
      industry_categories = FileUtils.parse_files(root_dir, ['industry-categories.json'], [], STARPEACE.industry.IndustryCategory.fromJson)
      ...
      industry_types = FileUtils.parse_files(root_dir, ['industry-types.json'], [], STARPEACE.industry.IndustryType.fromJson)
      ...
      levels = FileUtils.parse_files(root_dir, ['levels.json'], [], STARPEACE.industry.Level.fromJson)
      ...
      resource_types = FileUtils.parse_files(root_dir, ['resource-types.json'], [], STARPEACE.industry.ResourceType.fromJson)
      ...
      resource_units = FileUtils.parse_files(root_dir, ['resource-units.json'], [], STARPEACE.industry.ResourceUnit.fromJson)
